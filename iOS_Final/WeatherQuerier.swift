...
//        self.dataDelegate?.doGetWeatherJSON(res)
    ...
    func getDailyWeather(delegate : WeatherQueryCallback) {
        self.dataDelegate = delegate
        Alamofire.request(.GET, dailyWeatherURL, parameters: ["key":thinkPageKey,"location":"ip","days":"7"], encoding: .URL , headers: nil).response{response in
            let resJSON = JSON(data: response.2!)
            self.dataDelegate?.doGetWeatherJSON(resJSON)
        }
...
//        let res = JSON(data: "{\"results\":[{\"location\":{\"id\":\"WX4FBXXFKE4F\",\"name\":\"北京\",\"country\":\"CN\",\"path\":\"北京,北京,中国\",\"timezone\":\"Asia/Shanghai\",\"timezone_offset\":\"+08:00\"},\"daily\":[{\"aqi\":\"169\",\"pm25\":\"37\",\"pm10\":\"66\",\"so2\":\"3\",\"no2\":\"29\",\"co\":\"0.937\",\"o3\":\"234\",\"quality\":\"中度污染\",\"date\":\"2016-06-21\"},{\"aqi\":\"118\",\"pm25\":\"50\",\"pm10\":\"88\",\"so2\":\"8\",\"no2\":\"41\",\"co\":\"0.848\",\"o3\":\"179\",\"quality\":\"轻度污染\",\"date\":\"2016-06-22\"},{\"aqi\":\"48\",\"pm25\":\"12\",\"pm10\":\"26\",\"so2\":\"2\",\"no2\":\"13\",\"co\":\"0.2\",\"o3\":\"95\",\"quality\":\"优\",\"date\":\"2016-06-23\"},{\"aqi\":\"40\",\"pm25\":\"18\",\"pm10\":\"31\",\"so2\":\"2\",\"no2\":\"19\",\"co\":\"0.247\",\"o3\":\"80\",\"quality\":\"优\",\"date\":\"2016-06-24\"},{\"aqi\":\"51\",\"pm25\":\"16\",\"pm10\":\"30\",\"so2\":\"2\",\"no2\":\"20\",\"co\":\"0.233\",\"o3\":\"101\",\"quality\":\"良\",\"date\":\"2016-06-25\"},{\"aqi\":\"80\",\"pm25\":\"59\",\"pm10\":\"99\",\"so2\":\"16\",\"no2\":\"60\",\"co\":\"0.972\",\"o3\":\"127\",\"quality\":\"良\",\"date\":\"2016-06-26\"}],\"last_update\":\"2016-06-20T02:34:13+08:00\"}]}".dataUsingEncoding(NSUTF8StringEncoding)!)
//        self.dataDelegate?.doGetWeatherJSON(res)
    }
    ...
    func getSinaWeatherDetail(delegate : WeatherQueryCallback) {
        ...
        Alamofire.request(.GET, getEncodedURL(siniaWeatherURL, parameters: ["city":(NSUserDefaults.standardUserDefaults().objectForKey("DontGetColdCity") as! String ),"password":"DJOYnieT8234jlsK","day":"0"], encoding: GB180302000StringEncoding)).response{response in
            ...
            self.dataDelegate?.doGetWeatherJSON(res["Weather"])
        }
    }
